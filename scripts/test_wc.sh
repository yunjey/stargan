...
python code/main.py --mode test --dataset RaFD --c_dim 40 --rafd_image_dir data/world_cities/test --sample_dir stargan_wc/samples --log_dir stargan_wc/logs --model_save_dir stargan_wc/models --result_dir stargan_wc/results
