...
if __name__ == '__main__':
    ...
    # Test configuration.
    parser.add_argument('--test_iters', type=int, default=training_and_test_size, help='test model from this step')
    ...
    parser.add_argument('--model_save_step', type=int, default=model_save_step)
